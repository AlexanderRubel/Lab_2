...
|:---|:---|:---|
| 1 | Левая панель каталога  | Отображает содержимое каталога в вертикальном списке|
| 2 | Правая панель каталога | Отображает содержимое каталога в вертикальном списке|
| 3 | Описание функциональных клавиш клавиатуры | Отображает список клавиш клавиатуры, используемых для управления приложением|
| 4 | Строка вкладок | Отображает горизонтальный однострочный список открытых вкладок и выделяет активную|
